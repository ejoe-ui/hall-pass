...
export const SCHEDULES = {
  ...
  // Block Wed: periods 1, 3, 5, 7 run. covers[] maps combined block to single period ids.
  blockWed: { name: 'Block — Wednesday', periods: [
    { id:'1', label:'Periods 1 & 2', start:'08:10', end:'09:57', covers:['1','2'] },
    { id:'brunch', label:'Brunch', start:'09:57', end:'10:12', break:true },
    { id:'3', label:'Periods 3 & 4', start:'10:16', end:'11:59', covers:['3','4'] },
    { id:'lunch', label:'Lunch', start:'11:59', end:'12:33', break:true },
    { id:'5', label:'Periods 5 & 6', start:'12:37', end:'14:20', covers:['5','6'] },
    { id:'7', label:'Period 7', start:'14:24', end:'15:15' },
  ]},

  // Block Thu: periods 2, 4, 6, 7 run. covers[] maps combined block to single period ids.
  blockThu: { name: 'Block — Thursday', periods: [
    { id:'2', label:'Periods 1 & 2', start:'08:10', end:'09:57', covers:['1','2'] },
    { id:'brunch', label:'Brunch', start:'09:57', end:'10:12', break:true },
    { id:'4', label:'Periods 3 & 4', start:'10:16', end:'11:59', covers:['3','4'] },
    { id:'lunch', label:'Lunch', start:'11:59', end:'12:33', break:true },
    { id:'6', label:'Periods 5 & 6', start:'12:37', end:'14:20', covers:['5','6'] },
    { id:'7', label:'Period 7', start:'14:24', end:'15:15' },
  ]},
  ...
  middayActivityWed: { name: 'Midday Activity — Wednesday', periods: [
    { id:'1', label:'Periods 1 & 2', start:'08:10', end:'09:55', covers:['1','2'] },
    { id:'brunch', label:'Brunch', start:'09:55', end:'10:10', break:true },
    { id:'3', label:'Periods 3 & 4', start:'10:14', end:'11:55', covers:['3','4'] },
    { id:'activity', label:'Activity', start:'11:55', end:'12:30', break:true },
    { id:'lunch', label:'Lunch', start:'12:30', end:'13:00', break:true },
    { id:'5', label:'Periods 5 & 6', start:'13:04', end:'14:45', covers:['5','6'] },
    { id:'7', label:'Period 7', start:'14:49', end:'15:15' },
  ]},

  middayActivityThu: { name: 'Midday Activity — Thursday', periods: [
    { id:'2', label:'Periods 1 & 2', start:'08:10', end:'09:55', covers:['1','2'] },
    { id:'brunch', label:'Brunch', start:'09:55', end:'10:10', break:true },
    { id:'4', label:'Periods 3 & 4', start:'10:14', end:'11:55', covers:['3','4'] },
    { id:'activity', label:'Activity', start:'11:55', end:'12:30', break:true },
    { id:'lunch', label:'Lunch', start:'12:30', end:'13:00', break:true },
    { id:'6', label:'Periods 5 & 6', start:'13:04', end:'14:45', covers:['5','6'] },
    { id:'7', label:'Period 7', start:'14:49', end:'15:15' },
  ]},

  foggyBlockWed: { name: 'Foggy Block — Wednesday', periods: [
    { id:'1', label:'Periods 1 & 2', start:'10:00', end:'11:30', covers:['1','2'] },
    { id:'brunch', label:'Brunch', start:'11:30', end:'11:45', break:true },
    { id:'3', label:'Periods 3 & 4', start:'11:49', end:'13:15', covers:['3','4'] },
    { id:'lunch', label:'Lunch', start:'13:15', end:'13:49', break:true },
    { id:'5', label:'Periods 5 & 6', start:'13:53', end:'15:19', covers:['5','6'] },
    { id:'7', label:'Period 7', start:'15:23', end:'15:45' },
  ]},

  foggyBlockThu: { name: 'Foggy Block — Thursday', periods: [
    { id:'2', label:'Periods 1 & 2', start:'10:00', end:'11:30', covers:['1','2'] },
    { id:'brunch', label:'Brunch', start:'11:30', end:'11:45', break:true },
    { id:'4', label:'Periods 3 & 4', start:'11:49', end:'13:15', covers:['3','4'] },
    { id:'lunch', label:'Lunch', start:'13:15', end:'13:49', break:true },
    { id:'6', label:'Periods 5 & 6', start:'13:53', end:'15:19', covers:['5','6'] },
    { id:'7', label:'Period 7', start:'15:23', end:'15:45' },
  ]},
